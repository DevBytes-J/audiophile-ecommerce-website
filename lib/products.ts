...
export const products: Product[] = [
  ...
  },
  {
    ...
    features:
      "As the headphones all others are measured against, the XX99 Mark I demonstrates over five decades of audio expertise, redefining the critical listening experience for sound engineers, professional musicians, and audiophiles alike. Shell ear cups constructed from premium ABS material for extended durability.\n\nComfort was also top of mind when creating these headphones. Special foam cushions covered in plush velour, and pivoting earcups, ensure total immersion in your sound stage. The durable construction of the frame and cable allow you to transport your audio in style.",
    includes: [
      { quantity: 1, item: "Headphone unit" },
      { quantity: 2, item: "Replacement earcups" },
      { quantity: 1, item: "User manual" },
    ...
    others: [
      {
        ...
        name: "XX99 Mark II",
        image: {
          mobile: "/assets/shared/mobile/image-xx99-mark-two-headphones.jpg", // Corrected
          tablet: "/assets/shared/tablet/image-xx99-mark-two-headphones.jpg", // Corrected
          desktop: "/assets/shared/desktop/image-xx99-mark-two-headphones.jpg", // Corrected
        },
      },
      {
        slug: "xx59-headphones",
